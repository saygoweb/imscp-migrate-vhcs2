...
<form name="activate_customer" id="activate_customer" action="migrator.php" method="post">
    <label>
...
<table>
    ...
    <tr>
        ...
        <td>{DNS_NAME}</td>
        <td><textarea id="keyid_{LETSENCRYPT_ID}" name="migrator_key" style="width: 95%;height: 80px; resize: none;">{DOMAIN_KEY}</textarea></td>
    </tr>
    <!-- EDP: key_item -->
    </tbody>
</table>
<div class="buttons">
    <a style="color:#fff" class="link_as_button" href="migrator.php?action=deactivate&amp;admin_id={CUSTOMER_ID}">
        {TR_DEACTIVATE}
    </a>
</div>
<br/>
